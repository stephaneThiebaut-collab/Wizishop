...
export class ProduitService {
  ...
  produit: Array<Produit> = [
    { uuid: "48d0e776-6b3a-4d61-98c1-2fb3028b70a1", 
      ...
      littleDescription: "Clavier gaming - touches semi-mécaniques - châssis en métal - rétroéclairage RGB - AZERTY Français",
    ...
    { uuid: "efc09587-cc23-4b16-b534-dc1b015a2f0e", 
      ...
      littleDescription : "Clavier gaming - touches semi-mécaniques - rétroéclairage RGB - AZERTY Français",
    ...
    { uuid: "2efb24f6-502b-49b4-884e-1c23c3bb9a26", 
      ...
      littleDescription: "Clavier gaming avec ou sans fil - USB/RF 2.4 GHz - interrupteurs optiques rouges (switches ASUS ROG RX Red) - rétroéclairage RGB Aura Sync - pavé numérique amovible - repose-poignets magnétique - AZERTY, Français",
    ...
    { uuid: "725de77e-9d9b-4e1c-b1c4-5824b4f618c5", 
      ...
      littleDescription: "Clavier gaming avec ou sans fil - USB/Bluetooth/RF 2.4 GHz - format ultra-compact 60% - interrupteurs mécaniques (switches ASUS ROG RX Low Profile) - rétroéclairage RGB Aura Sync - AZERTY, Français",
    ...
    { uuid: "1a289892-7b97-4683-ba46-174e4a4d556f", 
      ...
      littleDescription: "Souris sans fil - droitier - capteur optique 8000 dpi - 7 boutons - molette exclusive pour le pouce - technologie Logitech Flow",
    ...
    { uuid: "4b7a5dd7-9019-4638-abe5-8cb41978c2d0", 
      ...
      littleDescription: "Souris sans fil - ambidextre - capteur optique 1000 dpi - 3 boutons",
    ...
    { uuid: "a80f4913-8e07-4fd2-8b43-836f0e78a963", 
      ...
      littleDescription: "Souris sans fil ergonomique - droitier - capteur laser 4000 dpi - 4 boutons",
    ...
    { uuid: "fefb2e4d-5f26-4b30-9ff4-0a369b26c574", 
      ...
      littleDescription: "Souris sans fil - ambidextre - capteur optique - 3 boutons",
    ...
    { uuid: "d1fc56db-1a0c-4910-ba41-93d6b3b649f8", 
      ...
      littleDescription: "Ecran PC Full HD 1080p - 1920 x 1080 pixels - 4 ms (gris à gris) - 16/9 - Dalle VA - 100 Hz - FreeSync - HDMI/VGA - Noir",
    ...
    { uuid: "78c2206e-342d-4968-a53f-4a5881910077", 
      ...
      littleDescription: "Ecran PC Full HD 1080p - 1920 x 1080 pixels - 1 ms (MPRT) - 16/9 - IPS - 165 Hz - Adaptive Sync - DisplayPort/HDMI/VGA - Noir/Rouge",
    ...
    { uuid: "e83f5aeb-d151-4f16-a6de-6a4d5c488f0d", 
      ...
      littleDescription: "Ecran PC 2.5K - 2560 x 1440 pixels - 1 ms (MPRT) - Format 16/9 - Dalle VA incurvée - 144 Hz - HDR10 - FreeSync Premium - HDMI/DisplayPort - Noir",
    ...
    { uuid: "043b79ac-273e-49a3-9273-09c081c9299e", 
      ...
      littleDescription: "Ecran PC Full HD 1080p - 1920 x 1080 pixels - 0.5 ms (MPRT) - Format large 16/9 - Dalle VA incurvée - 240 Hz - FreeSync Premium - DisplayPort - HDMI - Noir",
    ...
    { uuid: "a2542a0d-cfb8-41d8-9ae8-9e6a15607d1e", 
      ...
      littleDescription: "8 Go GDDR6 - HDMI/Tri DisplayPort - PCI Express (AMD Radeon RX 6600)",
    ...
    { uuid: "6e28986b-5983-4321-b3ec-aa2d940ad221", 
      ...
      littleDescription: "24 Go GDDR6 - HDMI/Tri DisplayPort - PCI Express (AMD Radeon RX 7900 XTX) - Article utilisé",
    ...
    { uuid: "d3684f5a-3e62-49c5-9f82-52c3a9384da8", 
      ...
      littleDescription: "12 Go GDDR6 - HDMI/Tri DisplayPort - PCI Express (AMD Radeon RX 7700 XT)",
    ...
    { uuid: "f0b151f1-4ef2-426a-8c6f-97dd2edfc43d", 
      ...
      littleDescription: "4 Go GDDR5 - DVI/HDMI/DisplayPort - PCI Express (AMD Radeon RX 550)",
